...
//            // Act
//            var result = _categoryService.AddCategoryAsync(categoryDto);
...
//            _repositoryManagerMock.Setup(r => r.CategoryRepository.GetCategoryById(categoryId)).Returns(category);
...
//            _repositoryManagerMock.Setup(r => r.CategoryRepository.GetCategoryById(categoryId)).Returns((Category)null);
...
//            _repositoryManagerMock.Setup(r => r.CategoryRepository.GetAllCategories()).Returns(categories);
...
//            _repositoryManagerMock.Setup(r => r.CategoryRepository.GetCategoryById(categoryDto.Id)).Returns(category);
...
//            _repositoryManagerMock.Setup(r => r.CategoryRepository.GetCategoryById(categoryDto.Id)).Returns((Category)null);
